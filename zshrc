...
plugins=(git git-auto-fetch z zsh-autosuggestions history-substring-search  zsh-syntax-highlighting cp safe-paste)
...
# powerline-status
#. /Library/Python/3.8/site-packages/powerline/bingdings/zsh/powerline.zsh
...
# python
export PATH="/opt/homebrew/Cellar/python@3.11/3.11.2/bin:$PATH"
#alias python
...
# some apps downloaded from github
